...
import { deleteApi as deleteStaffApi } from "@/api/staffs";
...
const deleteById = (id) => {
  //弹出确认框
  ElMessageBox.confirm("此操作将删除员工信息, 是否继续?", "提示", {
...
<template>
  ...
  <div class="container">
    ...
    >
      ...
      <el-table-column prop="reason" label="姓名" width="120" align="center">
        <template #default="scope">
          {{ nameCache[scope.row.id] || "加载中..." }}
        </template>
      </el-table-column>
      <el-table-column prop="reason" label="理由" width="600" align="center" />
      <el-table-column
        prop="time"
        label="请假时间"
        width="120"
